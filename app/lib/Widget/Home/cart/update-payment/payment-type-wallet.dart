...
class UpdatePaymentTypeDropDown extends StatefulWidget {
  // final TextEditingController payingTimeController;
  // PaymentTypeDropDown({required this.payingTimeController});
  @override
  _UpdatePaymentTypeDropDownState createState() => _UpdatePaymentTypeDropDownState();
}

class _UpdatePaymentTypeDropDownState extends State<UpdatePaymentTypeDropDown> {
