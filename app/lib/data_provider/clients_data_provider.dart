...
class ClientsDataProvider {
  ...
  final String baseUrl = 'http://csv.jithvar.com/api/v2';
  ...
  Future<List<Client>> searchClients(String searchData) async {
    ...
    try {
      ...
      if (response.statusCode != 200) {
        ...
        final extractedData =
            json.decode(response.body) as Map<String, dynamic>;
        print(extractedData);
        extractedData['clients'].forEach((value) {
          clientX.add(Client.fromJson(value));
        });
        // clientX = SearchClientData.fromJson(json.decode(response.body));
      }
    } catch (e) {
      print("error--seraching client");
      print(e);
      throw e;
    }
    return clientX;
